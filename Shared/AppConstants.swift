...
public struct SystemImages {
    ...
    public static let piholeSetupPassword = "key"
...
public struct UserText {
    ...
    public static let piholePasswordPlaceholder = String(localized: "Required for Pi-hole v6")
    public static let piholePasswordHelp = String(localized: "Use your Pi-hole web interface password")
    ...
    public static let systemMetricsDescription = String(localized: "Shows temperature, uptime, load, and memory reported by the Pi-hole API.")
    ...
    public struct MainView {
        ...
        public static let step3 = String(localized: "3. Get your password from Pi-hole settings")
