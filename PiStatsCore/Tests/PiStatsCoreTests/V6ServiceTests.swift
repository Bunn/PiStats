...
class V6ServiceTests: XCTestCase {
    ...
    func testFetchSummary_WithValidCredentials_ReturnsSummary() async throws {
        let url = URL(string: "http://127.0.0.1/api/stats/summary")
        ...
        let mockedData = JSONMock.summaryJSON(totalQueries: "\(ExpectedSummary.totalQueries)",
        ...
        URLProtocolMock.testURLs = [url: Data(mockedData.utf8)]
